...
void __fastcall TForm3::Timer1Timer(TObject *Sender) // скролл
{
int maxedit,maxstat;
...
{
InitDirectory="C:\\Documents and Settings\\WW\\My Documents\\cpp\\jim"; // перенести?
CLOSE_BUTTON->Left=Form3->Width-10;
CLOSE_BUTTON->Top=0;
// Регистрация ХОТКЕЕВ в системе
...
void __fastcall TForm3::Timer2Timer(TObject *Sender) // картинки
{
...
if (Form6->ComboBox3->ItemIndex==0)
SBT="   "+ModeStr[MediaPlayer1->Mode]+ " песни " + AnsiString(crofilename(MediaPlayer1->FileName)) + "  || всего песен: " + IntToStr(ListBox1->Items->Count) + " || " + retlength + " || Сейчас: " + Now() + "   ";
